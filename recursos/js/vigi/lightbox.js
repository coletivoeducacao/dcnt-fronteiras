...
document.querySelectorAll('img.lightbox, svg.lightbox').forEach(instance => {
    ...
    function select() {
        if (instance.tagName == 'svg') {
            lightboxImg.src = instance.querySelector('image')?.getAttribute('href');
        } else {
